...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Create Requirements</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                <form id="requirement_form" onsubmit="post('{{route('api.requirement.store')}}',this,'res');" method="post">
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="name">Requirement Title</label>
                            <input  type="text" class="form-control" id="name" name="name" required="required" placeholder="Name of a requirement">
                        </div>
...
@section('js')
        ...
        function post(url,data,id){
            ...
            ajcall.onload = function (e) {
                if (this.readyState ===4 && this.status===200){
                    ...
                    id.hidden=false;
                    get('{{route('api.requirement.all_requirements')}}','fields');
                }
    ...
    <form onsubmit="post('${window.location.origin+'/api/admin/requirement/update/'+id}',this,'res'); document.getElementById('dismiss-modal').click()">
...
`;
            let modal_requirement =document.getElementById('modal_requirement');
            modal_requirement.innerHTML = formModal;
    ...
    <form onsubmit="post('${window.location.origin+'/api/admin/requirement/delete/'+id}',this,'res'); document.getElementById('dismiss-modal').click()">
        <div class="modal-dialog">
          <div class="modal-content bg-danger">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <input  type="submit" class="btn btn-outline-light" value="Yes, delete this requirement">
            </div>
          </div>
        </form>
        </div>
`;
        ...
        window.onload = (e) => get('{{route('api.requirement.all_requirements')}}','fields');
