...
@section('content')
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('front/images/hero_1.jpg');" id="home-section">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 ml-auto">
                    <div class="p-4 mb-3 bg-white">
                        ...
                        <p class="mb-4">{{session()->get('w')->location}}</p>
                        <p class="mb-0 font-weight-bold">Phone</p>
                        <p class="mb-4"><a href="#">{{session()->get('w')->phone}}</a></p>
                        <p class="mb-0 font-weight-bold">Email Address</p>
                        <p class="mb-0"><a href="#">{{session()->get('w')->email}}</a></p>
