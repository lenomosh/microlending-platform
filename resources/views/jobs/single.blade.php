            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div class="custom-breadcrumbs">
                        ...
                        <a href="{{route('jobs.all')}}">Job</a> <span class="mx-2 slash">/</span>
    ...
    <section class="site-section">
        <div class="container">
            <div class="row align-items-center mb-5">
                <div class="col-lg-8 mb-4 mb-lg-0">
                    <div class="d-flex align-items-center">
                        <div class="border p-2 d-inline-block mr-3 rounded">
                            <img src="{{$job->company_logo}}" alt="Logo for {{$job->company_name}}">
                        </div>
                        <div>
                            <h2>{{$job->title}}</h2>
                            <div>
                                ...
                                <span class="m-2"><span class="icon-clock-o mr-2"></span><span class="text-primary">{{$job->period}}</span></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <a href="{{route('jobs.apply',$job->id)}}" class="btn btn-block btn-primary btn-md">Apply Now</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        <figure class="mb-5"><img src="{{$job->company_logo}}" alt="Free Website Template by Free-Template.co" class="img-fluid rounded"></figure>
                    ...
                    <div class="mb-5">
                        <h3 class="h5 d-flex align-items-center mb-4 text-primary"><span class="icon-book mr-3"></span>Other Information</h3>
                        {{$job->other_info}}
                    </div>
{{--
                    <div class="mb-5">
                ...
                <div class="col-lg-4">
                    <div class="bg-light p-3 border rounded mb-4">
                        ...
                        <ul class="list-unstyled pl-3 mb-0">
                            ...
                            <li class="mb-2"><strong class="text-black">Employment Status:</strong> {{$job->period}}</li>
                            ...
                            <li class="mb-2"><strong class="text-black">Salary:</strong> {{$job->salary}} - {{$job->salary - 5000}}</li>
    ...
    <!-- Go to www.addthis.com/dashboard to customize your tools -->
    <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5d88cb63b7ffa2e1"></script>
@stop